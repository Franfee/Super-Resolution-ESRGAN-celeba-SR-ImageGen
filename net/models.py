...
class FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        vgg19_model = vgg19()
        vgg19_model.load_state_dict(torch.load("net/pretrained/vgg19-dcbb9e9d.pth"))
...
class GeneratorRRDB(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, filters=64, num_res_blocks=16, num_upsample=2):
        ...
        # Upsampling layers
        upsample_layers = []
        for _out_features in range(num_upsample):
            upsample_layers += [
